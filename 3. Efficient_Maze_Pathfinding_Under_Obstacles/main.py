...
class MazeSolverApp(tk.Tk):
    ...
    def run_algorithm(self):
        ...
        csv_file_path = os.path.join("D:/Masters Projects/Master-In-AI/Foundation of Artificial Intelligence/Friend_Project/Maze_Project/maze_csvs", obstacle_files[obstacle_percentage])
